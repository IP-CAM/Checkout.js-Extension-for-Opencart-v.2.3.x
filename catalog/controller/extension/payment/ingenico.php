...
class ControllerExtensionPaymentIngenico extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'extension/payment/ingenico.tpl')) {
			return $this->load->view($this->config->get('config_template') . 'extension/payment/ingenico.tpl', $data);
		} else {
			return $this->load->view('extension/payment/ingenico.tpl', $data);
		}
	}
