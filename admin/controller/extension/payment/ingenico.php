...
class ControllerExtensionPaymentIngenico extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/ingenico', 'token=' . $this->session->data['token'], true)
		);
		
		$data['action'] = $this->url->link('extension/payment/ingenico', 'token=' . $this->session->data['token'], true);
		...
		/*if (isset($this->request->post['ingenico_request_type'])) {
		    $data['ingenico_request_type'] = $this->request->post['ingenico_request_type'];
		} else {
		    $data['ingenico_request_type'] = $this->config->get('ingenico_request_type');
		}*/
		...
		/*if (isset($this->request->post['ingenico_iv'])) {
		    $data['ingenico_iv'] = $this->request->post['ingenico_iv'];
		} else {
		    $data['ingenico_iv'] = $this->config->get('ingenico_iv');
		}*/
		...
		/*if (isset($this->request->post['ingenico_order_status'])) {
		    $data['ingenico_order_status'] = $this->request->post['ingenico_order_status'];
		} else {
		    $data['ingenico_order_status'] = $this->config->get('ingenico_order_status');
		}*/
		...
		$data['verification'] = $this->url->link('extension/payment/verification', 'token=' . $this->session->data['token'], true);
		$data['reconciliation'] = $this->url->link('extension/payment/reconciliation', 'token=' . $this->session->data['token'], true);
		$this->response->setOutput($this->load->view('extension/payment/ingenico.tpl', $data));
	}
	...
	public function order() {
		...
		return $this->load->view('extension/payment/ingenico_order.tpl', $data);
	...
	protected function validate() {
		...
		/*if (!trim($this->request->post['ingenico_request_type'])) {
		...
		/*if (!trim($this->request->post['ingenico_iv'])) {
		...
		/*if (!$this->request->post['ingenico_order_status']) {
