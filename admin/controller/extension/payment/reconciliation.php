...
class ControllerExtensionPaymentReconciliation extends Controller {
	public function index() {
        ...
        $data['action']= $this->url->link('extension/payment/reconciliation', 'token=' . $this->session->data['token'], true);
        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer'] = $this->load->controller('common/footer');
		$this->response->setOutput($this->load->view('extension/payment/reconciliation.tpl', $data	));
	}
